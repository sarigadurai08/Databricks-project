...
Tracks run-level metrics: rows read/written, timing, and status for each
pipeline invocation. Persists to a Delta audit table for SLA and ops reporting.
"""
...
class PipelineAuditor:
    ...
    Example:
        ...
        with auditor.track("patients") as ctx:
            # ... transform ...
            ctx["rows_read"] = 1000
