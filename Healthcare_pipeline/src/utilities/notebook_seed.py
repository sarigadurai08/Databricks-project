...
# This module is also importable once the project is on sys.path; notebooks
# inline an equivalent seed before the first project import.
...
def seed_project_root(dbutils: Any = None) -> str:
    """Find Healthcare_pipeline root and insert it at sys.path[0]."""
    ...
    raise FileNotFoundError(
        "Healthcare_pipeline root not found "
        "(expected config/config.py). Set HEALTHCARE_LAKEHOUSE_ROOT."
    )
