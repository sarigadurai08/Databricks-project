...
class EcommerceLakehouseError(Exception):
...
class IngestionError(EcommerceLakehouseError):
    """Raised when Auto Loader / file ingestion fails."""


class TransformationError(EcommerceLakehouseError):
    """Raised when silver/gold transforms fail."""


class DataQualityError(EcommerceLakehouseError):
    """Raised when critical data quality rules fail."""


class SchemaEvolutionError(EcommerceLakehouseError):
    """Raised on incompatible schema changes."""


class MergeConflictError(EcommerceLakehouseError):
    """Raised when Delta MERGE encounters an unexpected conflict."""


class ConfigurationError(EcommerceLakehouseError):
    """Raised for invalid configuration."""


class DeadLetterError(EcommerceLakehouseError):
    """Raised when a record is routed to the DLQ."""


class SimulatorError(EcommerceLakehouseError):
    """Raised when the streaming event simulator fails."""
